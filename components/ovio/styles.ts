...
export const styles = StyleSheet.create({
  ...
  expandedPlayerHandleArea: {
    alignItems: "center",
    gap: 8,
    paddingTop: 6,
  },
  expandedPlayerHandle: {
    width: 42,
    height: 5,
    borderRadius: 999,
    backgroundColor: "rgba(255, 255, 255, 0.34)",
  },
  expandedPlayerCenterBlock: {
    flex: 1,
    justifyContent: "center",
    paddingBottom: 0,
  },
  expandedPlayerTitleGroup: {
    alignItems: "center",
    gap: 4,
    marginTop: -28,
  },
  ...
  expandedPlayerProgressSection: {
    marginTop: 26,
    gap: 10,
  },
  expandedPlayerProgressTrack: {
    height: 4,
    borderRadius: 999,
    backgroundColor: "rgba(255, 255, 255, 0.18)",
    overflow: "hidden",
  },
  expandedPlayerProgressFill: {
    height: "100%",
    borderRadius: 999,
    backgroundColor: "#d8edf1",
  },
  expandedPlayerTimeRow: {
    flexDirection: "row",
    justifyContent: "space-between",
    alignItems: "center",
  },
  expandedPlayerTimeText: {
    fontSize: 12,
    letterSpacing: 0.2,
    fontWeight: "600",
    color: ovioColors.white,
  ...
  expandedPlayerSeekSymbol: {
    opacity: 0.98,
  },
  expandedPlayerSkipButtonInner: {
    width: 42,
    height: 42,
    alignItems: "center",
    justifyContent: "center",
  },
  expandedPlayerSkipLabel: {
    position: "absolute",
    fontSize: 10,
    lineHeight: 10,
    fontWeight: "800",
